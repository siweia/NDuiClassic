...
L["LoCAlert"] = "Loss of control alert" -- need translation
L["LoCAlertTip"] = "|nIf checked, alert when you loss of control from spells.|neg Blind, Sap, Freezing Trap." -- need translation
L["InstAlertOnly"] = "Only alert in instance" -- need translation
L["InstAlertOnlyTip"] = "|nIf checked, the notifications above only alert in instance. No longer alert in wild." -- need translation
L["Interrupt"] = "Прервано - %s > %s"
L["Steal"] = "Украдено - %s > %s"
L["Dispel"] = "Рассеяно - %s > %s"
L["BrokenSpell"] = "Сбито - %s > %s"
L["LossControl"] = "LoC - %s > %s (%ss %s)" -- need translation
...
L["Action*"] = "Действие*"
L["Action Intro"] = "|nSetup action for raidframes.|n|n- 'target': select target.|n|n- 'focus': set focus.|n|n- 'follow': follow unit.|n|n- numbers: spellID for casting spell.|n|n- macro: you can also type in macro text.|nIf the macro has multi-lines, use symbol ~ to break them." -- need translation
L["Key*"] = "Кнопка*"
...
L["AutoDismount"] = "Auto dismount on Taxi" -- need translation
L["AutoDismountTip"] = "|nAuto dismount after you choose your taxi destination." -- need translation
...
L["PlateRange"] = "Nameplate range" -- need translation
...
L["ClampTargetPlate"] = "Clamp Target Nameplate" -- need translation
L["ClampTargetPlateTip"] = "|nIf checked, the target namplate will always stay inside screen." -- need translation