...
L["Tutorial Page1"] = "Here is the tutorial to improve your experiencing.|n|nNow click the button to load some default settings that suit for NDui, include nameplate, actionbar, raidframes.|n|n|cffff0000These options cannot be skipped.|r"
...
L["Tutorial Page5"] = "Done! You have complete the tutorial.|n|n|cffff0000CAUTIONS:|r|n|n|cff00ccffNote that, most of the infobars contain extra functions;|n|nMost of the settings can be changed in |cffffcc00NDuiConsole|r.|r"
...
L["Instance Auras"] = "Show Custom Priority Debuffs"
...
L["Tank Mode"] = "Color unit when targeting you"
...
L["Interrupt"] = "Interrupt - %s[%s] > %s[%s]"
L["Steal"] = "Steal - %s[%s] > %s[%s]"
L["Dispel"] = "Dispel - %s[%s] > %s[%s]"
L["BrokenSpell"] = "Break - %s[%s] > %s[%s]"
...
L["Unit Intro"] = "|nThe spell's unit info.|n|nplayer: unit is player.|n|ntarget: unit is target.|n|npet: unit is pet."
...
L["Secure Color"] = "Select color when targeting you"
...
L["Instance Type"] = "|nSelect the instance type where the ID belongs to.|n|n'Raid' spells only available in Raids, 'Other' spells won't work in Raids."
...
L["TargetEnhancedMenu"] = "Enhanced target menu"
...
L["Pet&*Target"] = "Pet&TargetofTarget UFs"
...
L["MenuEnhancedTips"] = "|nAdd 'Guild Invite' and 'Add Friend' options in target right-click menu."
L["Nameplate ClassPowerOnly"] = "Hide HealthBar&PowerBar"
