...
L["Action*"] = "Action*"
L["Action Intro"] = "|nSetup action for raidframes.|n|ntarget, select target.|n|nfollow, follow unit.|n|nnumbers, spellID for casting spell.|n|nor you can just type in macro text.|nIf the macro has multi-lines, use \|n to break them."
L["Key*"] = "Key*"
...
L["QuestTracker"] = "Reskin QuestTracker"
...
L["MenuEnhancedTaints"] = "|nAdd 'Guild Invite' and 'Add Friend' options in right-click menu.|nThis option might taint your guild controls, enable if you have to."
