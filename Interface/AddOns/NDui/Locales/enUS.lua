...
L["Instance Type"] = "\nSelect the instance type where the ID belongs to.\n\n\'Raid\' spells only available in Raids, \'Other\' spells won't work in Raids."
...
L["DeleteMode Enabled"] = "\nYou can destroy container item by holding CTRL+ALT. The item quality must be lower than rare (blue)."
