...
L["Action*"] = "Action*"
L["Action Intro"] = "|nSetup action for raidframes.|n|n- 'target': select target.|n|n- 'focus': set focus.|n|n- 'follow': follow unit.|n|n- numbers: spellID for casting spell. This can only cast the highest rank of your spell.|n|n- macro: you can just type in macro text.|nIf the macro has multi-lines, use symbol ~ to break them.|nYou can only setup for different ranks of spells by macro [@mouseover]."
L["Key*"] = "Key*"
