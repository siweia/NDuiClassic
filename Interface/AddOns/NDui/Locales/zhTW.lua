...
L["Skip"] = "跳過"
L["Sort"] = "整理"
L["Chat Copy"] = "|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:230:307|t 複製|n|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:333:411|t 選單"
L["Collect All"] = "打開所有"
L["Collect Gold"] = "收取金幣"
...
L["ReminderTip"] = "|n根據自身職業，缺少特定Buff時進行提示。|n支持耐力/智力/戰鬥怒吼/野性印記/心靈之火/荊棘術。"
...
L["Action*"] = "行為*"
L["Action Intro"] = "|n為團隊框架設定按鍵行為。|n|n輸入target，設定目標；|n|n輸入follow，設定跟隨；|n|n輸入數字，設定施法的法術ID。此操作會固定使用最高等級的法術；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用符號~表示換行。|n若要設定不同等級的法術，你只能綁定巨集（指向）。|n|n你可以使用巨集來為不同專精分別設定:|n/cast [@mouseover,spec1]XXX;[@mouseover,spec2]XXX"
L["Key*"] = "按鍵*"
