...
L["Action*"] = "行为*"
L["Action Intro"] = "|n为团队框体设置按键行为。|n|n输入target，设置目标；|n|n输入follow，设置跟随；|n|n输入数字，设置施法的法术ID；|n|n你也可以直接输入宏。|n对于存在多行内容的宏命令，用\|n来进行换行。"
L["Key*"] = "按键*"
...
L["MenuEnhancedTaints"] = "|n给右键菜单添加公会邀请和添加好友选项。|n此选项会污染公会升降等操作，请按需加载。"
