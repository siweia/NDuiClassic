...
L["Instance Type"] = "\n选择你要添加的ID所属副本类型。\n\n团队分组的仅在团队副本内生效，其他分组的则在团队副本之外生效。"
L["Dungeons Intro"] = "\n选择你要添加的ID所属地下城。"
L["Raid Intro"] = "\n选择你要添加的ID所属团队副本。"
...
L["DeleteMode Enabled"] = "\n按住CTRL+ALT键，可直接点击摧毁背包中低于蓝色精良品质的物品。"
